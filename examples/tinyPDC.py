...
#    pdc4.run()  # Connect to PMU
    ...
    while True:
        ...
        data1=Process(target=pdc1.getmsg, args=(result_queue,))
        ...
        data2=Process(target=pdc2.getmsg, args=(result_queue1,))
        data2.start()
        ...
        data3=Process(target=pdc3.getmsg, args=(result_queue2,))
        data3.start()
